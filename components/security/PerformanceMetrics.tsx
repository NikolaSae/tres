...
import { AlertTriangle, Cpu, Activity, Clock } from "lucide-react";

// Tip podataka za metrike (mora biti identičan kao u hook-u)
...
const PerformanceMetrics: React.FC = () => {
  ...
  const calculateSummary = (data: PerformanceDataPoint[] | null): {

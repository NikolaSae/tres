///app/(protected)/reports/generate/_GenerateReportClient.tsx
      ...
      <Tabs defaultValue="financial" className="w-full">
        ...
        <TabsContent value="financial" className="space-y-4 mt-4">
          <Card className="p-6">
            ...
            <div className="space-y-6">
              ...
              <ExportOptions onExport={handleFinancialExport} allowedFormats={["excel", "pdf", "csv"]} />
            </div>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="services" className="space-y-4 mt-4">
          <Card className="p-6">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4" />
              <ExportOptions onExport={handleServicesExport} allowedFormats={["excel", "pdf", "csv"]} />
            </div>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="complaints" className="space-y-4 mt-4">
          <Card className="p-6">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4" />
              <ExportOptions onExport={handleComplaintsExport} allowedFormats={["excel", "pdf", "csv"]} />
            </div>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="contracts" className="space-y-4 mt-4">
          <Card className="p-6">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4" />
              <ExportOptions onExport={handleContractsExport} allowedFormats={["excel", "pdf", "csv"]} />
            </div>
          </Card>
        </TabsContent>
      </Tabs>

    ...
    try {
        switch (name) {
            case 'get_contracts':
                ...
                if (args.status)
                    contractsWhere.status = args.status;
                if (args.type)
                    contractsWhere.type = args.type;
            ...
            case 'get_complaints':
                ...
                if (args.status)
                    complaintsWhere.status = args.status;
                if (args.priority)
                    complaintsWhere.priority = args.priority;
            ...
            case 'get_providers':
                const providersWhere = {};
                if (args.isActive !== undefined)
                    providersWhere.isActive = args.isActive;
            ...
            case 'get_services':
                const servicesWhere = {};
                if (args.type)
                    servicesWhere.type = args.type;
                if (args.isActive !== undefined)
                    servicesWhere.isActive = args.isActive;
            ...
            case 'get_financial_summary':
                ...
                if (args.providerId)
                    vasTransactionsWhere.providerId = args.providerId;
                ...
                const parkingTransactionsWhere = {
                    date: {
                        gte: startDate,
                        lte: endDate
                    }
